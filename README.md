...
* [Hot Tub](packages/areas/garden/hottub/) scheduling and monitoring and Octopus Agile pricing optimisation for Balboa (and La-Z-Spa)
...
* Cost optimised charging of [Powerwall](packages/systems/tesla_powerwall) and [EVs](packages/systems/myenergi) for Octopus Agile TOU Electric Tarrif with [Solar Forecasting](https://forecast.solar/).
